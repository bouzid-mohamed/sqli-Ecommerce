 ...
 */
final class Version20220218131713 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client DROP email, DROP roles, DROP password, DROP photo, DROP num_tel, DROP is_deleted, DROP created_at, DROP updated_at, DROP type, DROP rest_token');
    }
}
